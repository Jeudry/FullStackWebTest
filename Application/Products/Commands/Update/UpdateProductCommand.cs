...
public record UpdateProductCommand(Guid Id, string Name, double Price, int Stock, DateTime CreatedAt, string? Description, DateTime? UpdatedAt = null) : IRequest<ErrorOr<Success>>;