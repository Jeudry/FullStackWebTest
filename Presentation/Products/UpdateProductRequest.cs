...
public sealed record UpdateProductRequest(Guid Id, string Name, string Code, double Price, int Stock, DateTime CreatedAt, string? Description = null, DateTime? UpdatedAt = null);